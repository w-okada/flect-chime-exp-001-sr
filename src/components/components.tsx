...
export const VideoInputSelect:FC<VideoInputSelectProps> = ({title, current, options, onchange}) => {
    type TargetType = "File" | "Window" | "Camera" | "SAMPLE_IMAGE" | "SAMPLE_MOVIE"
    ...
    const form = useMemo(()=>{
        ...
        videoInputList.push("SAMPLE_MOVIE")        
        ...
        const onchangeInternal = (val:string) =>{
            if(val === "File"){
                ...
                onchange("IMAGE_URL", "./img/yuka_kawamura.jpg")
                setTargetType("SAMPLE_IMAGE")                
            }else if(val === "SAMPLE_MOVIE"){
                // onchange("MOVIE_URL", "./movie/user018.mp4")
                onchange("MOVIE_URL", "./movie/user016.mp4")
                setTargetType("SAMPLE_MOVIE")                
            }else if(val === "Window"){
